    ...
    return (
        ...
        <section className="productos-search">
            ...
            <footer className="bg-secondary text-white" style={{ margin: "auto" }}>
                <div className="container-fluid text-center mt-5 p-4">
                    <div className="row">
                        <div className="col-12 col-md-6 col-lg-4 col-xxl-4 mt-5">
                            <p style={{ textAlign: "left", fontSize: "12px", letterSpacing: "5px" }}>
                                ESCRÍBENOS Y NOS PONDREMOS EN CONTACTO CONTIGO
                            </p>
                            <div>
                                <img 
                                    src="/imagenes/logo_emp.png" 
                                    alt="Logo"
                                    className="img-fluid img-thumbnail"
                                    style={{ backgroundColor: "transparent", border: "none" }}
                                    onError={(e) => {
                                        e.target.src = '/imagenes/logo_emp.jpg';
                                        console.log('Intentando cargar .jpg');
                                    }}
                                />
                            </div>
                        </div>
                        <div className="col-12 col-md-6 col-lg-8 col-xxl-8 mt-5">
                            ...
                            <div className="mb-4 mt-4">
                                <h1 style={{ fontSize: "clamp(1.5rem, 4vw, 3.5rem)", color: "#ff6600" }}>
                                    CONTACTO@FERREPRO.CO
                                </h1>
                                <hr />
                            </div>
                            ...
                            <div className="row">
                                <div className="col-12 col-md-6" style={{ textAlign: "left" }}>
                                    <h4>Contacto:</h4>
                                    <h6 style={{ marginLeft: "30px" }}>+57 399 123 4567</h6>
                                    <p style={{ marginLeft: "30px" }}>Calle 1 # 12a - 09, Alamos, Armenia - Quindío</p>
                                </div>
                                <div className="col-12 col-md-6" style={{ textAlign: "left" }}>
                    ...
                    <small>&copy; 2025 Grupo E - SENA. Todos los derechos reservados.</small>
                </div>
            </footer>
        </>
    );
