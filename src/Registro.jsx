          ...
          <div className='card shadow-lg border-0 rounded-4'>
            ...
            <div className='card-body p-5 bg-white'>
              <form onSubmit={handleRegistro}>
                ...
                <h6
                  className='text-muted text-uppercase fw-bold mt-4 mb-3'
                  style={{ fontSize: '0.8rem' }}
                >
                  Acceso a la Cuenta
                </h6>
                ...
                <div className='mb-4 form-check'>
                  ...
                  <label
                    ...
                    htmlFor='terms'
                  >
                    Acepto los términos de servicio y la política de tratamiento
                    de datos.
                  </label>
                </div>
                <button
                  type='submit'
                  className='btn btn-warning btn-lg w-100 fw-bold shadow-sm rounded-3 py-3'
                >
                  CREAR MI CUENTA
                </button>
              </form>
