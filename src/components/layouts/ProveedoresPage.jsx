...
function TopBar({ search, onSearch }) {
  return (
    <header className="w-full top-0 sticky z-40 bg-white/80 backdrop-blur-md shadow-[0_8px_24px_rgba(26,28,28,0.06)] ml-auto pl-64">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="bg-zinc-100 border-none rounded-lg pl-10 pr-4 py-2 text-sm w-72 focus:outline-none focus:ring-2 focus:ring-orange-500/20"
              placeholder="Buscar empresa o categoría..."
              style={{ fontFamily: "Manrope, sans-serif" }}
            />
          </div>
        </div>
        <div className="flex items-center gap-4">
          <button className="p-2 rounded-lg hover:bg-zinc-100 transition-colors active:scale-95">
          ...
          <div className="h-9 w-9 rounded-lg bg-orange-100 overflow-hidden ml-2 ring-1 ring-zinc-200 flex items-center justify-center">
