  ...
  return (
    <div className='container-fluid admin-body p-0'>
      <div className='row g-0'>
        ...
        <nav
          className={
            'col-md-3 col-lg-2 sidebar-industrial ' +
            (showSidebar ? 'show' : '')
          }
        >
          <div className='p-4 mb-4 d-flex justify-content-between align-items-center'>
            <div>
              ...
              >
                SOLUCIONES EN CONSTRUCCIÓN Y FERRETERÍA
              </small>
            </div>
          ...
          <div className='nav flex-column mt-4'>
            ...
            <MenuItem
              ...
              active={location.pathname === '/admin/inventario'}
            />
            <MenuItem
              to='/admin/ordenes'
              label='ÓRDENES'
            ...
            <MenuItem
              ...
              active={location.pathname === '/admin/proveedores'}
            />
          </div>

          <div className='mt-auto p-4' style={{ marginTop: '50px' }}>
            <div className='nav flex-column mb-4'>
              <a href='#' className='nav-link-industrial small'>
                <IconHelp size={18} className='me-2' /> Ayuda
              </a>
              <Link to='/login' className='nav-link-industrial small'>
                <IconLogout size={18} className='me-2' /> Salir
              </Link>
            </div>
        ...
        <main className='col-md-9 col-lg-10 main-content min-vh-100 ms-auto'>
          ...
          <header className='bg-white p-3 border-bottom d-flex align-items-center justify-content-between px-4 sticky-top'>
            ...
            <div className='d-flex align-items-center gap-2 gap-md-4'>
              <IconBell
                size={20}
                className='text-muted cursor-pointer d-none d-sm-block'
              />
              <IconSettings
                size={20}
                className='text-muted cursor-pointer d-none d-sm-block'
...
function DashboardView () {
    ...
    datasets: [
      {
        ...
        backgroundColor: context => {
          ...
          // Ajuste porque tus labels empiezan en LUN (índice 0)
          const mapDays = {
            1: 0, // lunes
            2: 1, // martes
            3: 2, // miércoles
          ...
          const activeIndex = mapDays[today]

          return index === activeIndex ? '#ff6600' : '#E2E8F0'
        },
        borderRadius: 8,
        borderSkipped: false
      }
  ...
  const barOptions = {
    ...
    scales: {
      ...
      x: {
        grid: { display: false },
        ticks: { font: { weight: 'bold', size: 10 }, color: '#A3AED0' }
      }
    }
  }
    ...
    <>
      <div className='d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-end mb-4 gap-3'>
        <div>
          ...
          <p className='text-muted small'>
            Estado en tiempo real de los activos de FerrePro.
          </p>
        </div>
        <div
          className='btn-group bg-white p-1 rounded-3 shadow-sm shadow-hover'
          role='group'
        >
          <button type='button' className='btn btn-sm btn-light fw-bold px-3'>
            Diario
          </button>
          <button
            type='button'
            className='btn btn-sm btn-white text-muted px-3'
          >
            Semanal
          </button>
          <button
      ...
      <div className='row g-4 mb-5'>
        ...
        <StatCard
          ...
          sub='⚠️ Requiere atención'
          subColor='text-danger'
        />
        <StatCard
          title='TASA DE DESPACHO'
          value='98.2%'
          sub='✅ Optimizado'
      ...
      <div className='row g-4 mb-5'>
        {/* RENDIMIENTO SEMANAL CHART.JS */}
        <div className='col-lg-8'>
          <div className='card card-stat'>
            <div className='d-flex justify-content-between align-items-center mb-4'>
              <h5 className='fw-bold mb-0'>Rendimiento Semanal</h5>
              <button className='btn btn-light btn-sm text-muted fw-bold'>
                Ver detalles
              </button>
            </div>
...
function OrderItem ({ id, client, total, status }) {
  return (
    <div className='d-flex align-items-center gap-3 mb-4'>
      <div
        className='bg-light p-2 rounded-4 text-center d-flex align-items-center justify-content-center'
      ...
      <div className='flex-grow-1 overflow-hidden'>
        <div className='d-flex justify-content-between align-items-start'>
          ...
          <span
            className={
              'badge-status ' +
              (status === 'PENDIENTE' ? 'badge-pending' : 'badge-shipped')
            }
          >
            {status}
          </span>
