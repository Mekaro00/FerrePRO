...
const FOOTER_METRICS = [
  ...
  },
  {
    ...
    icon: <IconDeviceAnalytics size={14} />,
    subClass: 'text-muted'
  },
  {
  ...
  return (
    <div className='container-fluid pb-5'>
      ...
      <div className='d-flex flex-column flex-md-row justify-content-between align-items-md-end mb-4 gap-3'>
        <div>
          <nav
            className='small text-uppercase fw-black mb-1'
          ...
          <p className='text-muted small'>
            Gestión de cuentas industriales y análisis de historial.
          </p>
        </div>
        <div className='d-flex gap-2'>
          <button
            className='btn btn-light border d-flex align-items-center gap-2 fw-bold small'
            onClick={() => {
              const headers = ['ID', 'Nombre', 'Email', 'Teléfono', 'Total']
          ...
          <div className='card border-0 shadow-sm h-100'>
                ...
                <tbody>
                  {clientes.map(c => (
                    <tr
                      ...
                      className={
                        selectedCustomer?.id === c.id ? 'table-active' : ''
                      }
                    >
                      <td className='ps-4'>
                        <div className='d-flex align-items-center gap-3'>
                          <div
                            className='bg-orange-subtle text-orange rounded fw-bold d-flex align-items-center justify-content-center'
                      ...
                      <td className='pe-4'>
                        <div className='d-flex justify-content-center align-items-center gap-2'>
                          <button
                            className="btn btn-sm btn-light border rounded-circle hover-shadow"
                            onClick={e => {
                              e.stopPropagation()
            ...
            <div className='card-footer bg-white p-3 d-flex justify-content-between align-items-center border-top'>
              <small className='text-muted'>
                Mostrando 1-{clientes.length} de {clientes.length} clientes
              </small>
              <div className='btn-group btn-group-sm'>
                {[1, 2, 3].map(p => (
                  <button
                    key={p}
                    className={`btn ${
                      page === p ? 'btn-orange' : 'btn-light border'
                    }`}
                    onClick={() => setPage(p)}
                  >
                    {p}
        ...
        <div className='col-xl-4'>
          <div className='card bg-dark text-white border-0 shadow mb-4 p-4 overflow-hidden position-relative'>
            <div className='position-relative z-index-1'>
              <span
                className='badge bg-orange text-white mb-3'
                style={{ fontSize: '0.6rem' }}
              >
                ENFOQUE CUENTA CLAVE
              </span>
              <div className='d-flex justify-content-between align-items-start mb-4'>
                <h3 className='fw-black'>{selectedCustomer?.name}</h3>
              ...
              <div className='mb-4'>
                <div className='d-flex justify-content-between border-bottom border-secondary pb-2 mb-2'>
                  ...
                  <span className='fw-bold'>{selectedCustomer?.total}</span>
                </div>
              ...
              <button className='btn btn-white w-100 fw-bold small py-2'>
                VER PERFIL DETALLADO
              </button>
            </div>
            <div
              className='position-absolute end-0 bottom-0 bg-orange opacity-10 rounded-circle'
              style={{
                width: '150px',
                height: '150px',
          ...
          <div className='card border-0 shadow-sm p-4 mb-4'>
            <h6 className='small fw-black text-muted text-uppercase mb-4'>
            ...
            <div className='d-flex flex-column gap-3'>
              <div className='d-flex align-items-center gap-3'>
                ...
                <div>
                  ...
                  <div className='small fw-bold'>{selectedCustomer?.email}</div>
                </div>
              </div>
              <div className='d-flex align-items-center gap-3'>
                <div className='bg-light border p-2 rounded'>
                ...
                <div>
                  ...
                  <div className='small fw-bold'>{selectedCustomer?.phone}</div>
                </div>
              </div>
              <div className='d-flex align-items-center gap-3'>
                <div className='bg-light border p-2 rounded'>
          ...
          <div className='card bg-light border-0 p-4'>
            <h6 className='small fw-black text-muted text-uppercase mb-3'>
              Línea de Tiempo
            </h6>
        ...
        {FOOTER_METRICS.map((m, i) => (
          <div className='col-md-3' key={i}>
            ...
            >
              ...
              <h3 className='fw-black my-1'>
                {m.label === 'Clientes Activos' ? clientes.length : m.value}
              </h3>
              <div
                className={`d-flex align-items-center gap-1 small fw-bold ${m.subClass}`}
              >
                {m.icon} {m.sub}
              </div>
            </div>
        ...
        >
          ...
          >
            ...
            <div className='d-flex justify-content-end gap-2'>
              ...
              <button className='btn btn-dark' onClick={guardarCliente}>
                Guardar
              </button>
            </div>
          </div>
